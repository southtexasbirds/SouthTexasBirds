...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "https://southtexasbirds.org/images/birds/altamira-oriole.webp", alt: "Altamira Oriole perched in South Texas" }],
  },
  twitter: {
    card: "summary_large_image",
    images: ["https://southtexasbirds.org/images/birds/altamira-oriole.webp"],
  },
};
