...
const PHOTO = "/images/birds/buff-bellied-hummingbird.webp";

export const metadata: Metadata = {
  alternates: { canonical: "/birds/buff-bellied-hummingbird" },
  ...
  openGraph: {
    ...
    images: [{ url: "https://southtexasbirds.org/images/birds/buff-bellied-hummingbird.webp", alt: "Buff-bellied Hummingbird at Sabal Palm Sanctuary, South Texas" }],
  },
  twitter: {
    card: "summary_large_image",
    images: ["https://southtexasbirds.org/images/birds/buff-bellied-hummingbird.webp"],
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 pb-20 flex flex-col gap-10">
        ...
        <AnimateIn>
          <section className="rounded-2xl p-7" style={{ background: "rgba(14,107,107,0.06)", border: "1px solid rgba(14,107,107,0.15)" }}>
            ...
            <p className="text-sm leading-relaxed" style={{ color: "#4E4B46" }}>
              <strong>Year-round</strong> — Buff-bellied Hummingbirds are permanent residents of the Rio Grande Valley and don&apos;t migrate south. Activity peaks during the <strong>flowering seasons: April through June</strong> (spring) and <strong>August through October</strong> (fall). In summer the Valley population expands northward along the coast, and some Valley birds make a post-breeding dispersal to the upper Texas coast. Feeders at Estero Llano Grande, Bentsen, and Santa Ana draw birds daily.
            </p>
          </section>
        </AnimateIn>
          ...
          <section className="rounded-2xl p-7" style={{ background: "#F7F0E4", boxShadow: "0 1px 6px rgba(14,107,107,0.07)" }}>
            ...
            <div className="flex flex-col gap-5">
              <Link href="/news/santa-ana-nwr-birding-guide" className="group flex flex-col gap-1 transition-opacity hover:opacity-80">
                ...
                <span className="text-sm" style={{ color: "#5C5954" }}>Buff-bellied Hummingbirds visit the nectar feeders at Santa Ana NWR year-round — a complete guide to the Valley&apos;s most species-rich reserve.</span>
              ...
              <Link href="/news/birds-only-in-south-texas" className="group flex flex-col gap-1 transition-opacity hover:opacity-80">
                ...
                <span className="text-sm" style={{ color: "#5C5954" }}>The Buff-bellied Hummingbird is one of South Texas&apos;s most distinctive resident specialties — the only hummingbird that breeds in the Rio Grande Valley as a year-round resident, rather than just passing through.</span>
                <span className="text-xs font-semibold tracking-widest uppercase mt-1" style={{ color: "#C77F4A" }}>Read article →</span>
              </Link>
            </div>
          </section>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "image": "https://southtexasbirds.org/images/birds/buff-bellied-hummingbird.webp",
