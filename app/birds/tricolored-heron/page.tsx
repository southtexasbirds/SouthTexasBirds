...
const PHOTO = "/images/birds/tricolored-heron.webp";
          ...
          <section className="rounded-2xl p-7" style={{ background: "#F7F0E4", boxShadow: "0 1px 6px rgba(14,107,107,0.07)" }}>
            ...
            <div className="flex flex-col gap-5">
              <Link href="/news/laguna-atascosa-birding-guide" className="group flex flex-col gap-1 transition-opacity hover:opacity-80">
                ...
                <span className="text-sm" style={{ color: "#5C5954" }}>Tricolored Herons hunt the shallow lagoons of Laguna Atascosa alongside Roseate Spoonbills and Reddish Egrets — a complete guide to birding South Texas&apos;s richest coastal refuge.</span>
              ...
              <Link href="/news/fall-shorebird-season-south-padre" className="group flex flex-col gap-1 transition-opacity hover:opacity-80">
                ...
                <span className="text-sm" style={{ color: "#5C5954" }}>Tricolored Herons are a constant presence along South Texas tidal flats and coastal lagoons — one of the elegant wading birds sharing the scene with migrating shorebirds each fall at South Padre Island.</span>
                <span className="text-xs font-semibold tracking-widest uppercase mt-1" style={{ color: "#C77F4A" }}>Read article →</span>
              </Link>
            </div>
          </section>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "image": "https://southtexasbirds.org/images/birds/tricolored-heron.webp",
