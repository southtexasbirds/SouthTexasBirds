...
const PHOTO = "/images/birds/gray-hawk.webp";
    ...
    <div style={{ background: "#EFE3CE" }}>
      ...
      <div className="max-w-4xl mx-auto px-6 pb-10">
        <AnimateIn>
          ...
          >
            <Image src={PHOTO} alt="Gray Hawk perched in riparian woodland" fill priority className="object-cover" style={{ objectPosition: "50% 30%" }} sizes="(max-width: 896px) 100vw, 896px" />
          </HeroFrame>
          ...
          <section className="rounded-2xl p-7" style={{ background: "#F7F0E4", boxShadow: "0 1px 6px rgba(14,107,107,0.07)" }}>
            ...
            <div className="flex flex-col gap-5">
              <Link href="/news/bentsen-rgv-state-park-birding-guide" className="group flex flex-col gap-1 transition-opacity hover:opacity-80">
                ...
                <span className="text-sm" style={{ color: "#5C5954" }}>The Gray Hawk soars above the Rio Grande at Bentsen-RGVSP April through August — a complete guide to the Valley&apos;s flagship birding destination where this riparian buteo is most reliably seen.</span>
              ...
              <Link href="/news/south-texas-raptor-specialties" className="group flex flex-col gap-1 transition-opacity hover:opacity-80">
                ...
                <span className="text-sm" style={{ color: "#5C5954" }}>The Gray Hawk is one of seven raptors found in the United States only in South Texas — a finely barred buteo of the river corridor that hunts lizards with accipiter-like agility through dense riparian forest.</span>
                <span className="text-xs font-semibold tracking-widest uppercase mt-1" style={{ color: "#C77F4A" }}>Read article →</span>
              </Link>
            </div>
          </section>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "image": "https://southtexasbirds.org/images/birds/gray-hawk.webp",
