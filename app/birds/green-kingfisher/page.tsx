...
const PHOTO = "/images/birds/green-kingfisher.webp";

export const metadata: Metadata = {
  alternates: { canonical: "/birds/green-kingfisher" },
  ...
  openGraph: {
    ...
    images: [{ url: "https://southtexasbirds.org/images/birds/green-kingfisher.webp", alt: "Male Green Kingfisher perched over clear water" }],
  },
    ...
    <div style={{ background: "#EFE3CE" }}>
      ...
      <div className="max-w-4xl mx-auto px-6 pt-5 pb-8">
        <AnimateIn direction="up">
          ...
          <p className="text-base italic mb-3" lang="la" style={{ color: "#5C5954" }}>
            Chloroceryle americana &nbsp;·&nbsp; <span className="not-italic" lang="es">Martín pescador verde</span>
          </p>
      ...
      <div className="max-w-4xl mx-auto px-6 pb-10">
        <AnimateIn>
          ...
          >
            <Image src={PHOTO} alt="Male Green Kingfisher perched over clear water, South Texas" fill priority className="object-cover" style={{ objectPosition: "50% 35%" }} sizes="(max-width: 896px) 100vw, 896px" />
          </HeroFrame>
      ...
      <div className="max-w-4xl mx-auto px-6 pb-20 flex flex-col gap-10">
        ...
        <AnimateIn>
          <section className="rounded-2xl p-7" style={{ background: "rgba(14,107,107,0.06)", border: "1px solid rgba(14,107,107,0.15)" }}>
            ...
            <p className="text-sm leading-relaxed" style={{ color: "#4E4B46" }}>
              <strong>Year-round</strong> — Green Kingfishers are permanent residents along clear-water streams and resacas in the Rio Grande Valley. They are tiny (sparrow-sized) and easily overlooked, but sit conspicuously on low branches and rocks directly over the water. The most reliable sites are the slow-moving resacas at Santa Ana NWR and the clear streams at Estero Llano Grande. <strong>October through April</strong> is ideal — lower vegetation makes the birds easier to spot. Walk slowly along any resaca edge and scan low branches near the waterline.
            </p>
          </section>
        </AnimateIn>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "image": "https://southtexasbirds.org/images/birds/green-kingfisher.webp",
