...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "https://southtexasbirds.org/images/birds/red-billed-pigeon.webp", alt: "Red-billed Pigeon perched in tropical forest" }],
  },
          ...
          <section className="rounded-2xl p-7" style={{ background: "#F7F0E4", boxShadow: "0 1px 6px rgba(14,107,107,0.07)" }}>
            ...
            <div className="flex flex-col gap-5">
              <Link href="/news/bentsen-rgv-state-park-birding-guide" className="group flex flex-col gap-1 transition-opacity hover:opacity-80">
                ...
                <span className="text-sm" style={{ color: "#5C5954" }}>The river overlook deck at Bentsen-RGVSP is the most consistent U.S. spot for Red-billed Pigeon — a complete guide to the flagship Rio Grande Valley birding destination.</span>
