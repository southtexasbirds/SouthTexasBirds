...
const PHOTO = "/images/birds/ringed-kingfisher.webp";
    ...
    <div style={{ background: "#EFE3CE" }}>
      ...
      <div className="max-w-4xl mx-auto px-6 pt-5 pb-8">
        <AnimateIn direction="up">
          ...
          <p className="text-base italic mb-3" lang="la" style={{ color: "#5C5954" }}>
            Megaceryle torquata &nbsp;·&nbsp; <span className="not-italic" lang="es">Martín real</span>
          </p>
      ...
      <div className="max-w-4xl mx-auto px-6 pb-10">
        <AnimateIn>
          ...
          >
            <Image src={PHOTO} alt="Male Ringed Kingfisher perched over the Rio Grande" fill priority className="object-cover" style={{ objectPosition: "50% 30%" }} sizes="(max-width: 896px) 100vw, 896px" />
          </HeroFrame>
          ...
          <section className="rounded-2xl p-7" style={{ background: "#F7F0E4", boxShadow: "0 1px 6px rgba(14,107,107,0.07)" }}>
            ...
            <div className="flex flex-col gap-5">
              <Link href="/news/bentsen-rgv-state-park-birding-guide" className="group flex flex-col gap-1 transition-opacity hover:opacity-80">
                ...
                <span className="text-sm" style={{ color: "#5C5954" }}>The Ringed Kingfisher patrols the Rio Grande at Bentsen-RGVSP year-round — a complete guide to the Valley&apos;s flagship birding destination and the river species it protects.</span>
              ...
              <Link href="/news/salineno-birding-guide" className="group flex flex-col gap-1 transition-opacity hover:opacity-80">
                ...
                <span className="text-sm" style={{ color: "#5C5954" }}>Ringed Kingfishers are guaranteed year-round at Salineño Wildlife Preserve — one of several key target species covered in our complete guide to this upper RGV destination.</span>
                <span className="text-xs font-semibold tracking-widest uppercase mt-1" style={{ color: "#C77F4A" }}>Read article →</span>
              </Link>
            </div>
          </section>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "image": "https://southtexasbirds.org/images/birds/ringed-kingfisher.webp",
