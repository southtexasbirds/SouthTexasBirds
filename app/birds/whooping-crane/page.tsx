...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "https://southtexasbirds.org/images/birds/whooping-crane.webp", alt: "Whooping Crane wading in shallow water" }],
  },
  twitter: {
    card: "summary_large_image",
    images: ["https://southtexasbirds.org/images/birds/whooping-crane.webp"],
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 pt-5 pb-8">
        <AnimateIn direction="up">
          ...
          <p className="text-base italic mb-3" lang="la" style={{ color: "#5C5954" }}>
            Grus americana &nbsp;·&nbsp; <span className="not-italic" lang="es">Grulla blanca</span>
          </p>
          <span
