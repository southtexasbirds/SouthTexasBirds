...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "https://southtexasbirds.org/images/birds/piping-plover.webp", alt: "Piping Plover on a sandy beach" }],
  },
  twitter: {
    card: "summary_large_image",
    images: ["https://southtexasbirds.org/images/birds/piping-plover.webp"],
  },
};
          ...
          <section className="rounded-2xl p-7" style={{ background: "#F7F0E4", boxShadow: "0 1px 6px rgba(14,107,107,0.07)" }}>
            ...
            <div className="flex flex-col gap-5">
              <Link href="/news/laguna-atascosa-birding-guide" className="group flex flex-col gap-1 transition-opacity hover:opacity-80">
                ...
                <span className="text-sm" style={{ color: "#5C5954" }}>Laguna Atascosa&apos;s tidal flats protect nationally significant numbers of wintering Piping Plovers — a complete guide to birding South Texas&apos;s largest coastal refuge.</span>
              ...
              <Link href="/news/fall-shorebird-season-south-padre" className="group flex flex-col gap-1 transition-opacity hover:opacity-80">
                ...
                <span className="text-sm" style={{ color: "#5C5954" }}>South Padre Island hosts nationally significant concentrations of Piping Plovers each fall — and the conservation pressures on that habitat are growing.</span>
                <span className="text-xs font-semibold tracking-widest uppercase mt-1" style={{ color: "#C77F4A" }}>Read article →</span>
              </Link>
            </div>
          </section>
