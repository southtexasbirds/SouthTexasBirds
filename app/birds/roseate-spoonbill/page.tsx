...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "https://southtexasbirds.org/images/birds/roseate-spoonbill.webp", alt: "Roseate Spoonbill wading in shallow water" }],
  },
          ...
          <section className="rounded-2xl p-7" style={{ background: "#F7F0E4", boxShadow: "0 1px 6px rgba(14,107,107,0.07)" }}>
            ...
            <div className="flex flex-col gap-5">
              <Link href="/news/laguna-atascosa-birding-guide" className="group flex flex-col gap-1 transition-opacity hover:opacity-80">
                ...
                <span className="text-sm" style={{ color: "#5C5954" }}>Roseate Spoonbills are most abundant at Laguna Atascosa April through August — a guide to birding South Texas&apos;s largest and most diverse wildlife refuge.</span>
              ...
              <Link href="/news/fall-shorebird-season-south-padre" className="group flex flex-col gap-1 transition-opacity hover:opacity-80">
                ...
                <span className="text-sm" style={{ color: "#5C5954" }}>Roseate Spoonbills roost and feed along the same tidal flats where South Texas shorebirds concentrate each fall — one of the most spectacularly colored birds sharing the scene with migrating Piping Plovers.</span>
                <span className="text-xs font-semibold tracking-widest uppercase mt-1" style={{ color: "#C77F4A" }}>Read article →</span>
              </Link>
            </div>
          </section>
