...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "https://southtexasbirds.org/images/birds/white-collared-seedeater.webp", alt: "White-collared Seedeater male showing black-and-white pattern" }],
  },
        ...
        <AnimateIn>
          <section className="rounded-2xl p-7" style={{ background: "#F7F0E4", boxShadow: "0 1px 6px rgba(14,107,107,0.07)" }}>
            ...
            <Link href="/news/salineno-birding-guide" className="group flex flex-col gap-1 transition-opacity hover:opacity-80">
              ...
              <span className="text-sm" style={{ color: "#5C5954" }}>Salineño Wildlife Preserve is the most reliable U.S. site for White-collared Seedeater — our complete guide covers the best season, what to listen for, and how to plan the visit.</span>
