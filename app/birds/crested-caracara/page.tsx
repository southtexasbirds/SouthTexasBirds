...
const PHOTO = "/images/birds/crested-caracara.webp";

export const metadata: Metadata = {
  alternates: { canonical: "/birds/crested-caracara" },
    ...
    <div style={{ background: "#EFE3CE" }}>
      ...
      <div className="max-w-4xl mx-auto px-6 pb-10">
        <AnimateIn>
          ...
          >
            <Image src={PHOTO} alt="Crested Caracara perched in South Texas open country" fill priority className="object-cover" style={{ objectPosition: "50% 25%" }} sizes="(max-width: 896px) 100vw, 896px" />
          </HeroFrame>
          ...
          <section className="rounded-2xl p-7" style={{ background: "#F7F0E4", boxShadow: "0 1px 6px rgba(14,107,107,0.07)" }}>
            ...
            <div className="flex flex-col gap-5">
              <Link href="/news/south-texas-raptor-specialties" className="group flex flex-col gap-1 transition-opacity hover:opacity-80">
                ...
                <span className="text-sm" style={{ color: "#5C5954" }}>The Crested Caracara is one of South Texas&apos;s most distinctive resident raptors — a falcon that walks like a vulture, scavenges like a vulture, and is unmistakable on any fence post in the region.</span>
              ...
              <Link href="/news/fall-hawk-migration-south-texas" className="group flex flex-col gap-1 transition-opacity hover:opacity-80">
                ...
                <span className="text-sm" style={{ color: "#5C5954" }}>Crested Caracaras are permanent residents of South Texas open country — look for them perched on fence posts while scanning for migrating Broad-winged Hawks overhead each September.</span>
                <span className="text-xs font-semibold tracking-widest uppercase mt-1" style={{ color: "#C77F4A" }}>Read article →</span>
              </Link>
            </div>
          </section>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "url": "https://southtexasbirds.org/birds/crested-caracara",
            ...
            "image": "https://southtexasbirds.org/images/birds/crested-caracara.webp",
