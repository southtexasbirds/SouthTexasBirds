...
const PHOTO = "/images/birds/vermilion-flycatcher.webp";

export const metadata: Metadata = {
  alternates: { canonical: "/birds/vermilion-flycatcher" },
  ...
  openGraph: {
    ...
    images: [{ url: "https://southtexasbirds.org/images/birds/vermilion-flycatcher.webp", alt: "Male Vermilion Flycatcher perched on a branch" }],
  },
    ...
    <div style={{ background: "#EFE3CE" }}>
      ...
      <div className="max-w-4xl mx-auto px-6 pt-5 pb-8">
        <AnimateIn direction="up">
          ...
          <p className="text-base italic mb-3" lang="la" style={{ color: "#5C5954" }}>
            Pyrocephalus rubinus &nbsp;·&nbsp; <span className="not-italic" lang="es">Mosquero cardenal</span>
          </p>
      ...
      <div className="max-w-4xl mx-auto px-6 pb-10">
        <AnimateIn>
          ...
          >
            <Image src={PHOTO} alt="Male Vermilion Flycatcher perched on a branch, South Texas" fill priority className="object-cover" style={{ objectPosition: "50% 30%" }} sizes="(max-width: 896px) 100vw, 896px" />
          </HeroFrame>
          ...
          <section className="rounded-2xl p-7" style={{ background: "#F7F0E4", boxShadow: "0 1px 6px rgba(14,107,107,0.07)" }}>
            ...
            <div className="flex flex-col gap-5">
              <Link href="/news/south-texas-birding-calendar" className="group flex flex-col gap-1 transition-opacity hover:opacity-80">
                ...
                <span className="text-sm" style={{ color: "#5C5954" }}>Vermilion Flycatchers are most abundant in South Texas from October through April — the seasonal birding calendar explains when to time a visit to catch peak numbers of this blazing red bird at Valley parks and pond edges.</span>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "url": "https://southtexasbirds.org/birds/vermilion-flycatcher",
            ...
            "image": "https://southtexasbirds.org/images/birds/vermilion-flycatcher.webp",
