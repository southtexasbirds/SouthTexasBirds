      ...
      <div className="max-w-4xl mx-auto px-6 pt-5 pb-8">
        <AnimateIn direction="up">
          ...
          <p className="text-base italic mb-3" lang="la" style={{ color: "#5C5954" }}>
            Icterus graduacauda &nbsp;·&nbsp; <span className="not-italic" lang="es">Bolsero de Audubon</span>
          </p>
          ...
          <section className="rounded-2xl p-7" style={{ background: "#F7F0E4", boxShadow: "0 1px 6px rgba(14,107,107,0.07)" }}>
            ...
            <div className="flex flex-col gap-5">
              <Link href="/news/bentsen-rgv-state-park-birding-guide" className="group flex flex-col gap-1 transition-opacity hover:opacity-80">
                ...
                <span className="text-sm" style={{ color: "#5C5954" }}>Audubon&apos;s Orioles visit the feeders at Bentsen-RGVSP regularly — a complete guide to the RGV&apos;s flagship World Birding Center site and the species it hosts year-round.</span>
              ...
              <Link href="/news/salineno-birding-guide" className="group flex flex-col gap-1 transition-opacity hover:opacity-80">
                ...
                <span className="text-sm" style={{ color: "#5C5954" }}>Salineño Wildlife Preserve is one of the most reliable U.S. sites for Audubon&apos;s Oriole — the feeders and dense thornscrub bring these secretive birds into view during spring and summer.</span>
                <span className="text-xs font-semibold tracking-widest uppercase mt-1" style={{ color: "#C77F4A" }}>Read article →</span>
              </Link>
            </div>
          </section>
