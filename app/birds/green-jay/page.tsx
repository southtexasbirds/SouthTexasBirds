...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "https://southtexasbirds.org/images/birds/green-jay.webp", alt: "Green Jay perched in South Texas thornscrub" }],
  },
  twitter: {
    card: "summary_large_image",
    images: ["https://southtexasbirds.org/images/birds/green-jay.webp"],
  },
};
          ...
          <section className="rounded-2xl p-7" style={{ background: "#F7F0E4", boxShadow: "0 1px 6px rgba(14,107,107,0.07)" }}>
            ...
            <div className="flex flex-col gap-5">
              <Link href="/news/santa-ana-nwr-birding-guide" className="group flex flex-col gap-1 transition-opacity hover:opacity-80">
                ...
                <span className="text-sm" style={{ color: "#5C5954" }}>Santa Ana NWR is the flagship site for Green Jay in the United States — a complete guide to the Rio Grande Valley&apos;s most species-rich reserve, where Green Jays rule the feeder station year-round.</span>
              ...
              <Link href="/news/thornscrub-restoration-rgv" className="group flex flex-col gap-1 transition-opacity hover:opacity-80">
                ...
                <span className="text-sm" style={{ color: "#5C5954" }}>Less than 5% of native thornscrub remains — conservation groups are rebuilding the habitat the Green Jay depends on.</span>
                <span className="text-xs font-semibold tracking-widest uppercase mt-1" style={{ color: "#C77F4A" }}>Read article →</span>
              </Link>
            </div>
          </section>
